...
from data import v2, v1, COCODetection, detection_collate, COCOroot
...
def train():
    ...
    dataset = COCODetection(args.root_path, train_sets, SSDAugmentation(
        ssd_dim, means), target_transform=True)
