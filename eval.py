    ...
    for cls_ind, cls in enumerate(labelmap):
        ...
        with open(filename, 'wt') as f:
            for im_ind, index in enumerate(dataset.ids):
                ...
                for k in range(dets.shape[0]):join
...
if __name__ == '__main__':
    ...
    # load data
    dataset = VOCDetection(args.voc_root, ['val2017'], BaseTransform(ssd_dim, dataset_mean), AnnotationTransform())
    if args.cuda:
        net = net.cuda()
